...
- **Columns:**
  ...
  | ----------- | --------- | ----------- |
  | customer_key | INT | Surrogate key unquely identifying each customer record in the dimension table. |
  ...
  | birthdate | DATE | The date of birth the customer, formatted as YYYY-MM-DD (e.g., 2026-02-25) |
...
- **Columns:**
  | Column Name | Data Type | Description |
  | ----------- | --------- | ----------- |
  | product_key | INT | Surrogate key unquely identifying each customer record in the dimension table. |
  | product_id | INT | A unique indentifier assigned to the product for internal tracking and referencing. |
  | product_number | NVARCHAR(50) | A structured alphanumeric code representing the product, often used for categorization or inventory. |
  | product_name | NVARCHAR(50) | Descriptive name of the product, including key details such as type, coloer and size. |
  ...
  | start_date | DATE | The date when the product became available for sale or use, stored in. |
    ...
    ### 3. gold.fact_sales
- **Purpose:** Stores transactional sales data fpr analytical purposes.
- **Columns:**
  | Column Name | Data Type | Description |
  | ----------- | --------- | ----------- |
